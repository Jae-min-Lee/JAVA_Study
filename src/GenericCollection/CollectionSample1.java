 ...
 * 
 * 
 * 단점 : 형변환이 필요하므로 속도가 저하된다.
 * public static void plritArray (T[] TArray){
...
public class CollectionSample1 {
	...
	public static void main(String[] args) {
		SimpleGeneric<Integer> sg1 = new SimpleGeneric<Integer>(12);
